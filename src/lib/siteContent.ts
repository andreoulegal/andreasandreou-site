...
const defaults: SiteContentMap = {
  ...
  'home.closing.eyebrow': 'Andreas Andreou',
  'home.closing.title': 'Lawyer, public-sector professional and founder based in Athens.',
  'home.closing.button_label': 'Read my bio',
